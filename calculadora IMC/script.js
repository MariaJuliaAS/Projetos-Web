...
function calcular(event){
    ...
    resultado = document.getElementById('resultado');//dentro da var resultado vai ter a div(foi pega pelo id) onde vai ser escrita o resultado
    ...
    document.getElementById('peso').value = ''; //para limpar os campos depois
